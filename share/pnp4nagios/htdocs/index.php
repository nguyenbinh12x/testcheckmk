...
define('PNP_ETC_PATH' , '/omd/versions/2.0.0p9.cre/etc/pnp4nagios');
define('PNP_LOG_PATH' , '/omd/versions/2.0.0p9.cre/var/pnp4nagios');
 ...
 * This path can be absolute or relative to this file.
 */
$kohana_system = '/omd/versions/2.0.0p9.cre/lib/kohana/system';
